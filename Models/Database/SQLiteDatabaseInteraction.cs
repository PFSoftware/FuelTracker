...
using PFSoftware.FuelTracker.Models.Entities;
...
namespace PFSoftware.FuelTracker.Models.Database
{
    ...
    internal class SQLiteDatabaseInteraction : IDatabaseInteraction
    {
        ...
        public void VerifyDatabaseIntegrity() => Functions.VerifyFileIntegrity(
            Assembly.GetExecutingAssembly().GetManifestResourceStream($"PFSoftware.FuelTracker.{_DATABASENAME}"), _DATABASENAME, AppData.Location);
